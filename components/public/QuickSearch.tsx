              ...
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full text-xs font-semibold px-4 py-3 border border-[var(--color-border)] rounded-lg focus:outline-none focus:border-amber-500 pr-10 transition-all duration-300 text-black"
